...
class Encoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.encoder_layer1 = layers.Dense(12, kernel_initializer=tf.keras.initializers.he_normal())        
        self.encoder_active_layer1 = layers.LeakyReLU(name="encoder_leakyrelu_1")
        
        self.encoder_layer2 = layers.Dense(10, kernel_initializer=tf.keras.initializers.he_normal())
        self.encoder_active_layer2 = layers.LeakyReLU(name="encoder_leakyrelu_2")
        
        self.encoder_layer3 = layers.Dense(8, kernel_initializer=tf.keras.initializers.he_normal())
...
class Decoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.decoder_layer2 = layers.Dense(8, kernel_initializer=tf.keras.initializers.he_normal())         
        self.decoder_active_layer2 = layers.LeakyReLU(name="decoder_leakyrelu_2")    
        
        self.decoder_layer3 = layers.Dense(10, kernel_initializer=tf.keras.initializers.he_normal())
        self.decoder_active_layer3 = layers.LeakyReLU(name="decoder_leakyrelu_3")
        
        self.decoder_layer4 = layers.Dense(12, kernel_initializer=tf.keras.initializers.he_normal())
