...
modelN = 222#sys.argv[1]
DIM = 5#sys.argv[2]
EPOCHS = 100
vaename = "/gwpool/users/glavizzari/Downloads/vae_test_newModelDimenstions_MinMaxScaler_30_20_10_5_100"
...
np.savetxt("./WandL/model"+str(modelN)+"S_lossSM_split.csv", myloss,delimiter=',')
np.savetxt("./WandL/model"+str(modelN)+"S_lossSM_total.csv", mylossSM,delimiter=',')
np.savetxt("./WandL/model"+str(modelN)+"S_lossLIN_total.csv", mylossLIN,delimiter=',')
np.savetxt("./WandL/model"+str(modelN)+"S_lossQUAD_total.csv", mylossQUAD,delimiter=',')

np.savetxt("./WandL/model"+str(modelN)+"S_weightsSM_split.csv", wx_test,delimiter=',')
np.savetxt("./WandL/model"+str(modelN)+"S_weightsSM_total.csv", weightsSM,delimiter=',')
np.savetxt("./WandL/model"+str(modelN)+"S_weightsLIN_total.csv", weightsLIN,delimiter=',')
np.savetxt("./WandL/model"+str(modelN)+"S_weightsQUAD_total.csv", weightsQUAD,delimiter=',')
