...
class Encoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.encoder_layer4 = layers.Dense(16, kernel_initializer=tf.keras.initializers.he_normal())
        self.encoder_active_layer4 = layers.LeakyReLU(name="encoder_leakyrelu_4")   
    ...
    def call(self, inputs): #Calls the model on new inputs.
        ...
        xl4_active = self.encoder_active_layer3(xl4)
        
        z_mean = self.dense_mean(xl4_active)
        z_log_var = self.dense_log_var(xl4_active)
...
class Decoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.decoder_layer2 = layers.Dense(16, kernel_initializer=tf.keras.initializers.he_normal())         
        self.decoder_active_layer2 = layers.LeakyReLU(name="decoder_leakyrelu_2")
        
        self.decoder_layer3 = layers.Dense(32, kernel_initializer=tf.keras.initializers.he_normal())         
        self.decoder_active_layer3 = layers.LeakyReLU(name="decoder_leakyrelu_3")    
        
        self.decoder_layer4 = layers.Dense(64, kernel_initializer=tf.keras.initializers.he_normal())
        self.decoder_active_layer4 = layers.LeakyReLU(name="decoder_leakyrelu_4")
        
        self.decoder_layer5 = layers.Dense(128, kernel_initializer=tf.keras.initializers.he_normal())
