...
class Encoder(layers.Layer):
    ...
    def __init__(self,
        ...
        self.encoder_layer1 = layers.Dense(64, kernel_initializer=tf.keras.initializers.he_normal())        
        self.encoder_active_layer1 = layers.LeakyReLU(name="encoder_leakyrelu_1")
        
        self.encoder_layer2 = layers.Dense(32, kernel_initializer=tf.keras.initializers.he_normal())
        self.encoder_active_layer2 = layers.LeakyReLU(name="encoder_leakyrelu_2")
        
        self.encoder_layer3 = layers.Dense(16, kernel_initializer=tf.keras.initializers.he_normal())
