# python trainingBEST.py latent_dimension
...
#enc_name = "BESTenc_denselayers_latentdim{}_epoch{}_batchsize{}_log_eventFiltered".format(DIM, EPOCHS, BATCH)
...
vae_name = "BESTvae_denselayers_latentdim{}_epoch{}_batchsize{}_log_eventFiltered".format(DIM, EPOCHS, BATCH)
csv_name = "BESTloss_training_latentdim{}_epoch{}_batchsize{}_log_eventFiltered.csv".format(DIM, EPOCHS, BATCH)
