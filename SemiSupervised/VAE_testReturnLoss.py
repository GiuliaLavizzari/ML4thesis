...
class classifier(layers.Layer):
    ...
    def __init__(self,                      
        ...
        self.classifier_layer0 = layers.Dense(50,activation="relu")        
        self.classifier_layer1 = layers.Dense(1,activation='hard_sigmoid')        
        
    def call(self, inputs):
        #print "\n Inputs classifier", inputs
        layer0 = self.classifier_layer0(inputs) 
        output = self.classifier_layer1(layer0)                 
...
class VariationalAutoEncoder(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        mseLoss = mse(inputs, reconstructed)        
        self.add_loss(mseLoss) # may be I could just pass the output of the self.recoLoss ?
        ...
        #myLoss = self.recoLoss([inputs,reconstructed]) 
        #print "recoLoss = ", myLoss 
        #myOutput = self.classifier(myLoss)       
